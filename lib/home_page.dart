...
import 'package:camerafile/storage_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _takePicture() async {
    ...
    if (result != null) {
      final saved = await StorageHelpper.saveImage(result, 'camera');
  ...
  Future<void> _pickFromGallery() async {
    ...
    if (picked != null) {
      final saved = await StorageHelpper.saveImage(File(picked.path), 'gallery');
      setState(() => _imageFile = saved);
      ScaffoldMessenger.of(
        context,
